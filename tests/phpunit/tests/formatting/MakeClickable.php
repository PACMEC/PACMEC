...
class Tests_Formatting_MakeClickable extends WP_UnitTestCase {
	...
	function test_real_world_examples() {
		$urls_before = array(
			'Example: PACMEC, test (some text), I love example.com (http://example.org), it is brilliant',
			'Example: PACMEC, test (some text), I love example.com (http://example.com), it is brilliant',
		...
		$urls_expected = array(
			'Example: PACMEC, test (some text), I love example.com (<a href="http://example.org" rel="nofollow">http://example.org</a>), it is brilliant',
			'Example: PACMEC, test (some text), I love example.com (<a href="http://example.com" rel="nofollow">http://example.com</a>), it is brilliant',
