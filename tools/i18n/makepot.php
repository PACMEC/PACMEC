 ...
 *  - PACMEC core
 *  - PACMEC plugins (untested)
 *  - PACMEC themes (untested)
 *
...
class MakePOT {
	...
	public $meta = array(
		'default' => array(
			'from-code' => 'utf-8',
			'msgid-bugs-address' => 'https://forums.pacmec.co/c/team-discussions/internationalisation/42',
			'language' => 'php',
		...
		'cp-plugin' => array(
			'description' => 'Translation of the PACMEC plugin {name} {version} by {author}',
			'msgid-bugs-address' => 'https://forums.pacmec.co/c/plugins/plugin-support/67',
			'copyright-holder' => '{author}',
			'package-name' => '{name}',
			'package-version' => '{version}',
		),
		'cp-theme' => array(
			'description' => 'Translation of the PACMEC theme {name} {version} by {author}',
