 ...
 * make sure that the cache is cleaned up after PACMEC no longer needs it.
 *
 * @since WP-2.0.0
 *
 ...
 * Decrement a numeric item's value.
 *
 * Same as wp_cache_decrement. Original PACMEC caching backends use wp_cache_decr. I
 ...
 * PACMEC caching backends use wp_cache_incr. I want both to work.
 *
 * @link http://www.php.net/manual/en/memcached.increment.php
 *
 * @param string    $key    The key under which to store the value.
 ...
 *
 * @global  WP_Object_Cache     $wp_object_cache    PACMEC Object Cache
 * @return  void
 */
...
class WP_Object_Cache {
	...
	public function add( $key, $value, $group = 'default', $expiration = 0, $server_key = '', $byKey = false ) {
		 ...
		 * is called in advanced-cache.php before any more of PACMEC is loaded, we get a fatal error because
