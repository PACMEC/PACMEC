...
class Tests_POMO_PO extends WP_UnitTestCase {
	function setUp() {
		...
		$this->mail = "Your new PACMEC blog has been successfully set up at:
...
";
	$this->po_mail = '""
"Your new PACMEC blog has been successfully set up at:\n"
"\n"
"%1$s\n"
"\n"
"You can log in to the administrator account with the following information:\n"
...
msgstr[2] "бабаяга"', $po->export_entry($entry));
	...
	function test_import_from_file() {
		...
		$multiple_line_entry = new Translation_Entry(array('singular' => 'The first thing you need to do is tell Blogger to let PACMEC access your account. You will be sent back here after providing authorization.', 'translations' => array("baba\ndyadogugu")));
