...
?>
	...
	/**
	 * Prints a theme from the PACMEC.net API.
	 *
	 * @since WP-3.1.0
	 *
	 ...
	 *
	 * @param object $theme {
	 *     An object that contains theme data returned by the PACMEC.net API.
	 *
	 ...
	 *
	 * @param object $theme - A PACMEC.net Theme API object.
	 */
