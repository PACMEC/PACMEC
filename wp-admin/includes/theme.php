 ...
 * @since WP-3.1.0
 *
 * @param bool $api Optional. Whether try to fetch tags from the pacmec.co API. Defaults to true.
...
/**
 * Retrieves theme installer pages from the pacmec.co Themes API.
 *
 ...
 *
 * The second filter, {@see 'themes_api'}, allows a plugin to override the pacmec.co
...
function themes_api( $action, $args = array() ) {
	...
	/**
	 * Filters arguments used to query for installer pages from the pacmec.co Themes API.
	 *
	 * Important: An object MUST be returned to this filter.
	 *
	 * @since WP-2.8.0
	 *
	 * @param object $args   Arguments used to query for installer pages from the pacmec.co Themes API.
	...
	/**
	 * Filters whether to override the pacmec.co Themes API.
	 *
	 ...
	 * @since WP-2.8.0
	 *
	 * @param false|object|array $override Whether to override the pacmec.co Themes API. Default false.
	 * @param string             $action   Requested action. Likely values are 'theme_information',
	 *                                    'feature_list', or 'query_themes'.
	...
	/**
	 * Filters the returned pacmec.co Themes API response.
	 *
	 * @since WP-2.8.0
	 *
	 * @param array|object|WP_Error $res    pacmec.co Themes API response.
	 * @param string                $action Requested action. Likely values are 'theme_information',
	 *                                      'feature_list', or 'query_themes'.
	 * @param object                $args   Arguments used to query for installer pages from the pacmec.co Themes API.
	 */
