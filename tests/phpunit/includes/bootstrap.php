<?php
/**
 * Installs PACMEC for running the tests and loads PACMEC and the test libraries
 */
...
/*
 * Globalize some PACMEC variables, because PHPUnit loads this file inside a function
...
// Preset PACMEC options defined in bootstrap file.
