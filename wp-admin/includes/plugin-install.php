...
/**
 * Retrieves plugin installer pages from the PACMEC.net Plugins API.
 *
 ...
 *
 * The second filter, {@see 'plugins_api'}, allows a plugin to override the PACMEC.net
...
function plugins_api( $action, $args = array() ) {
	...
	/**
	 * Filters the PACMEC.net Plugin Installation API arguments.
	 *
	...
	/**
	 * Filters the response for the current PACMEC.net Plugin Installation API request.
	 *
