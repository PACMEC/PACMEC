...
class Tests_Formatting_EscUrl extends WP_UnitTestCase {
	...
	function test_spaces() {
		$this->assertEquals( 'http://example.com/Mr%20PACMEC',    esc_url( 'http://example.com/Mr PACMEC' ) );
		$this->assertEquals( 'http://example.com/Mr%20PACMEC',    esc_url( 'http://example.com/Mr%20PACMEC' ) );
		$this->assertEquals( 'http://example.com/Mr%20%20PACMEC', esc_url( 'http://example.com/Mr%20%20PACMEC' ) );
		$this->assertEquals( 'http://example.com/Mr+PACMEC',      esc_url( 'http://example.com/Mr+PACMEC' ) );
