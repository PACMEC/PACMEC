<?php
/**
 * PACMEC TwentySixteen functions and definitions
 *
...
function cp2016_setup() {
	load_theme_textdomain( 'pacmec-twentysixteen' );
}
...
function cp2016_enqueue_styles() {
	...
	wp_enqueue_style(
		'pacmec-twentysixteen',
		get_stylesheet_directory_uri() . '/style.css',
		array( $parent_style ),
		pacmec_asset_version( 'style', 'pacmec-twentysixteen' )
	);
}
