 ...
 *
 * Resets the state of the PACMEC installation before and after every test.
 *
 * Includes utility functions and assertions useful for testing PACMEC.
 *
 * All PACMEC unit tests should inherit from this class.
 */
class WP_UnitTestCase extends PHPUnit_Framework_TestCase {
	...
	/**
	 * Fetches the factory object for generating PACMEC fixtures.
	 *
	...
	/**
	 * After a test method runs, reset any state in PACMEC the test method might have changed.
	 */
	function tearDown() {
	...
	/**
	 * Modify PACMEC's query internals as if a given URL has been requested.
	 *
